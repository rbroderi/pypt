...
from pypt.creator_core import ci_ops
from pypt.creator_core import license_ops
from pypt.creator_core import project_ops
from pypt.creator_core import templates
from pypt.creator_core.project_ops import GitAuthor
...
def get_version() -> str:
    try:
        return importlib.metadata.version("pypt")
